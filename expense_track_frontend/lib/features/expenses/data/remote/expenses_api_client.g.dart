...
part of 'expenses_api_client.dart';
...
class _ExpensesApiClient implements ExpensesApiClient {
  _ExpensesApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<ExpenseModel>> getExpenses() async {
    ...
    final _options = _setStreamType<List<ExpenseModel>>(
  ...
  Future<ExpenseModel> getExpense(String id) async {
    ...
    late ExpenseModel _value;
    try {
      _value = ExpenseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
